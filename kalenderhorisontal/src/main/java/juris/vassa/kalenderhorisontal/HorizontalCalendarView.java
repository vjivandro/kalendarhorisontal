package juris.vassa.kalenderhorisontal;
...
import juris.vassa.kalenderhorisontal.adapter.HorizontalCalendarBaseAdapter;
...
/**
 * See {juris.vassa.kalenderhorisontal.R.styleable#HorizontalCalendarView HorizontalCalendarView Attributes}
 *
 * @author juris vassa
 * @since v1.0.0
 */
public class HorizontalCalendarView extends RecyclerView {
    ...
    public HorizontalCalendarView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.KalenderHorisontalView,
                0, 0);

        try {
            int textColorNormal = a.getColor(R.styleable.KalenderHorisontalView_textColorNormal, Color.LTGRAY);
            int colorTopText = a.getColor(R.styleable.KalenderHorisontalView_colorTopText, textColorNormal);
            int colorMiddleText = a.getColor(R.styleable.KalenderHorisontalView_colorMiddleText, textColorNormal);
            int colorBottomText = a.getColor(R.styleable.KalenderHorisontalView_colorBottomText, textColorNormal);

            int textColorSelected = a.getColor(R.styleable.KalenderHorisontalView_textColorSelected, Color.BLACK);
            int colorTopTextSelected = a.getColor(R.styleable.KalenderHorisontalView_colorTopTextSelected, textColorSelected);
            int colorMiddleTextSelected = a.getColor(R.styleable.KalenderHorisontalView_colorMiddleTextSelected, textColorSelected);
            int colorBottomTextSelected = a.getColor(R.styleable.KalenderHorisontalView_colorBottomTextSelected, textColorSelected);
            Drawable selectedDateBackground = a.getDrawable(R.styleable.KalenderHorisontalView_selectedDateBackground);

            int selectorColor = a.getColor(R.styleable.KalenderHorisontalView_selectorColor, fetchAccentColor());
            float sizeTopText = getRawSizeValue(a, R.styleable.KalenderHorisontalView_sizeTopText,
                    HorizontalCalendarConfig.DEFAULT_SIZE_TEXT_TOP);
            float sizeMiddleText = getRawSizeValue(a, R.styleable.KalenderHorisontalView_sizeMiddleText,
                    HorizontalCalendarConfig.DEFAULT_SIZE_TEXT_MIDDLE);
            float sizeBottomText = getRawSizeValue(a, R.styleable.KalenderHorisontalView_sizeBottomText,
